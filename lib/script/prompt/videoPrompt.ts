...
export const VIDEO_PROMPT_FORMAT = dedent`
  ## Video prompts
  A <video> prompt is one line of two or more numbered shots, about one shot per 2 to 5 seconds. Each shot gives the framing and camera move, what happens, the setting details that matter, then any speech. Every shot except the last ends with Sound:. The last shot has no Sound and no speech, because the end of a video gets cut off: Shot 1: ... Sound: ... Shot 2: ... Sound: ... Shot 3: ...
