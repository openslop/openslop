...
${languagePrompt(language)}
  ...
  - Example: <video characters="Red,Wolf" overlays="rain" startFrame="none" trimToDialogue="false">Wide shot of a moonlit forest clearing as Red and Wolf walk in from the trees, rain falling through the branches. Sound: rain pattering on leaves, a stream nearby.</video>
