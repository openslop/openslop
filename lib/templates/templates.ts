...
export const TEMPLATES: Template[] = [
	...
	},
	{
		...
		exampleText: dedent`
			...
			#Video: Ethan stares at a bathtub as dollar bills swirl down the drain. He reaches in too late — the last bill slips away.
			#Narration: Right now. Today. And you probably don't even know it's happening.

			#Video: Ethan holds up a sign that says "$86/month." It flips to reveal "$219/month." His eyes go wide.
			...
			#Video: Giant red text slams onto the screen behind Ethan — "$133 EXTRA / MONTH." His jaw drops to the floor.
			#Narration: That's 133 dollars more than people think. Every. Single. Month.

			#Video: A pie chart spins next to Ethan. A 42% red slice pops out as he points at it.
			#Narration: And 42 percent of people are paying for stuff they already stopped using.

			#Video: Ethan sits at a dark kitchen table, face lit by his phone. The screen shows "$43.17" with a red arrow pointing down. A question mark floats above his head.
			...
			#Video: Ethan slumps on a couch. Dollar bills float up around him and disappear into the ceiling, one by one.
			...
			#Video: Ethan stands in workout clothes in an empty gym. A single treadmill hums on its own behind him. Tumbleweed rolls past.
			...
			#Video: Ethan holds up a shiny gym card. The price "$69 / MONTH" stamps onto the screen behind him.
			#Narration: The average gym costs 69 dollars a month.

			#Video: Ethan peeks through a Planet Fitness window. Text floats above him — "60% never visit in 30 days." Crickets chirp inside.
			...
			#Video: Ethan at a chalkboard writes "$69 × 12 = $828." He circles the answer, then sighs.
			#Narration: If you pay and don't go, that's 828 dollars a year. Gone.

			#Video: Ethan holds up an envelope stamped "CANCELLATION LETTER." It grows arms and runs away from him.
			...
			#Video: Ethan on the couch points a remote. Netflix, Hulu, Disney+, and Paramount+ logos circle around his head like planets.
			...
			#Video: Stats pop into the air next to Ethan one by one — "ESPN+: 26%" — "Hulu: 26%" — "Paramount+: 25%" — "Disney+: 23%." Each one lands with a thud.
			...
			#Video: Ethan scrolls Netflix endlessly. His thumb gets tired. Popcorn sits cold next to him.
			#Narration: Even Netflix — the most popular one — 17 percent of people haven't opened it in a month.

			#Video: A price tag in front of Ethan flips from "$15" to "$20." He winces but doesn't move.
			...
			#Video: Ethan reaches for a glowing mousetrap labeled "FREE 7-DAY TRIAL." The trap snaps shut on his credit card. He yelps.
			#Narration: You sign up for a free trial. You type in your credit card. You forget. Seven days later — you're paying.

			#Video: Ethan opens his bank app. A red alert bubble pops up — "65% of Americans got charged." He clutches his chest.
			...
			#Video: Ethan taps "Download" on his phone. A "DAY 1" stamp slams onto the screen. A speech bubble next to him reads "89%."
			...
			#Video: Ethan signs up, then immediately taps "Cancel" with a sly grin. A pop-up emails him — "Wait! 50% off to come back!"
			...
			#Video: Ethan at his desk crosses items off a notepad. A list reads "Leak 1 ✓ Leak 2 ✓ Leak 3 ✓." He looks up with growing excitement.
			...
			#Video: Ethan holds a new TV box at a checkout. The cashier leans forward with a wide smile — "Want the protection plan?" Ethan freezes.
			#Narration: You buy a TV. The cashier asks, "Want to add the protection plan?" The answer is almost always: no.

			#Video: Two giant glowing numbers float in the sky above Ethan — "$1.27 BILLION collected" and "$210 MILLION paid back." He stares up, mouth open.
			#Narration: Last year, Lowe's made over a billion dollars selling warranties. They only paid back 210 million.

			#Video: A dollar bill rips in two in front of Ethan. He's left holding a tiny 17-cent scrap. The giant 83-cent piece flies into a store window.
			#Narration: That means for every dollar you spend on a warranty, the store keeps 83 cents. You get back 17.

			#Video: Three appliance icons line up next to Ethan — a TV, microwave, and dishwasher. Tiny break percentages pop above each one. He points down the line.
			...
			#Video: Ethan flashes a thumbs up. Green text booms next to him — "SKIP THE WARRANTY."
			...
			#Video: Ethan backs away as old subscription logos crawl out of a graveyard, zombie style. They claw their way onto his credit card.
			#Narration: These are the worst. The subscription is dead to you. But it's still alive on your credit card.

			#Video: Ethan stares at a card floating in front of him — "60% forgot a recurring payment." He scratches his head.
			...
			#Video: Ethan punches numbers into a calculator. The screen flashes "$50 × 12 = $600." His shoulders drop.
			#Narration: That's 600 dollars a year. For nothing.

			#Video: Ethan flips a calendar. Three months in a row are stamped red with a giant X. He winces with each flip.
			...
			#Video: A factory machine labeled "BIG COMPANIES" runs in front of Ethan. A mechanical arm reaches into his pocket and pulls out dollar bills onto a conveyor belt.
			...
			#Video: Ethan grabs a big red lever. He yanks it down. The conveyor belt reverses. Money pours back into his piggy bank. He grins.
			...
			#Video: Close up of Ethan's iPhone. His thumb taps "Settings" → his name → "Subscriptions." A long list scrolls into view.
			...
			#Video: Ethan's thumb taps "Cancel" over and over. A counter ticks up — "1, 2, 3, 4, 5…" — and his smile grows bigger with each tap.
			...
			#Video: Ethan at his kitchen table holds a red marker. He circles repeating charges on his bank statement — one, two, three — as the numbers glow.
			...
			#Video: Ethan types into his email search bar — "subscription, renewal, free trial." Old emails fly out of the screen and pile up around him.
			...
			#Video: Ethan on the couch eats popcorn calmly. A clock ticks loud beside him. He shrugs — nothing to miss.
			...
			#Video: Ethan taps his bank app and sets up an auto-transfer. A glowing arrow labeled "$100 / month" flows out of his account and into a piggy bank.
			...
			#Video: Older Ethan with grey hair stands under a giant money tree. Leaves of cash drift down around him. A glowing "$632,000" hangs at the top.
			...
			#Video: Ethan points at bold text that bounces onto the screen — "Can't do 12%? Start with 1%." A tiny coin drops into a piggy bank beside him.
			...
			#Video: A dark screen. Ethan's silhouette stands small and hunched. White text appears next to him — "You pay. You forget. They win."
			#Sound: [low, slow heartbeat]
			#Narration: You pay. You forget. They win.

			#Video: The silhouette of Ethan slowly straightens up tall and strong. The text rewrites itself — "Or you can stop forgetting."
...
#Narration: What's different is quieter than that. And it makes you wonder. What are you really building? And who is it for?`,
	},
	{
		...
		systemPrompt: dedent``,
		exampleText: dedent`#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Diego Maradona.

#Narration: Diego Maradona.

#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: Diego Maradona with a big scribbled mop of black curly hair, squinting grin, wearing a light blue and white striped shirt and black shorts. One arm is raised, holding a shaded gold trophy aloft. Bottom third: a bright green band packed with a doodled crowd of fans — white outlined heads, raised arms, and cheering hands surging upward around him, a few gray blobs among them reading as cameras. Crowd cheering.

#Narration: Diego Armando Maradona (1960) was widely regarded as one of the greatest footballers in history.

#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: a cartoon figure of Diego Maradona with a scribbled mop of black curly hair, closed eyes, small smile and red blush marks, wearing a light blue and white striped shirt and black shorts, both arms raised outward. Thin black stick legs. Flanking him: on the left, a flag of Forza Napoli; on the right, a waving Argentine flag, light blue and white bands with the golden sun face in the middle. Bottom third: a flat bright green band running the full width, standing in for the pitch. Flags popping in one by one, Diego smiling.

#Narration: He was a symbol of Argentina and Napoli and the 1986 World Cup champion.

#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: a cartoon figure of Diego Maradona with a scribbled mop of black curly hair, now older-looking — heavy brows, tired downturned eyes, a gray beard and mustache. He wears a light blue and white striped shirt and black shorts, with thin black stick legs. In one hand he holds a large tilted green alcohol bottle; in the other, a small cluster of white pills. Bottom half: a flat muted green band running the full width.

#Narration: After retiring in 1997, his health suffered a serious decline due to alcohol and drug use.

#Video: Whiteboard-style doodle of a hospital room, "Diego Maradona" hand-lettered at the top in marker font. Muted olive-green wall, white floor, a curtain and IV pole at the left edge, a pale window panel at the right. Left of center: a cartoon figure of Diego Maradona lying on a white bed, seen from above the head — big scribbled mop of black curly hair, eyes closed, in a dark gown. Center: a large pink cross-section diagram of a brain overlayed on the image, with a dark red dot marked on it indicating Hematoma. Right: a small cartoon doctor facing forward — green surgical cap, light blue face mask, white coat over blue scrubs, stethoscope around the neck, one arm raised toward the diagram. The doctor appearing, then the brain diagram appearing.

#Narration: In 2020, Maradona underwent surgery to remove a subdural hematoma.

#Video: Whiteboard-style doodle of a hospital room, "Diego Maradona" hand-lettered at the top. Olive-green wall, white floor, curtain and IV pole at the left. Center: a cartoon figure of Diego Maradona sitting up on a bed — scribbled black curly hair, gray beard, tired droopy eyes with shadows beneath, gray gown, thin stick limbs. Two red-circled callout diagrams linked to him by red arrows: upper right, a pair of red lungs with blue fluid dripping; lower left, a red heart looking distressed and misshapen. At the right, a dark monitor screen showing an irregular green ECG line. First the red lungs callout appearing, then the red heart, then the ECG monitor, Diego looking sad and unhealthy.
...
#Video: Whiteboard-style doodle on a white background with a gray floor band, "Diego Maradona" hand-lettered at the top. Left: two identical cartoon nurses standing side by side — white caps with red crosses, light blue face masks, blue scrubs, thin stick legs. Right: a cartoon doctor walking away with an angry scowling brow — green surgical cap, blue mask, white coat over blue scrubs, stethoscope, motion lines behind him. Behind him, a simple building with a red roof.

#Narration: However, the home medical team failed to recognize the severity. No doctor was consistently present at the house.

#Video: Whiteboard-style doodle, "Diego Maradona" hand-lettered at the top. Muted, subdued palette. Left: a cartoon figure of Diego Maradona lying in bed, seen head-on from above — scribbled black curly hair, gray beard, eyes closed with shadows beneath, gray gown, a gray blanket pulled up over him against a white pillow. Right: a dark monitor screen showing a flat green line. Below it, a dull dark-red heart with a black X drawn across it. Dark monitor ECG screen getting progressively flatter, heart gradually failing, Diego passing away in the bed.

#Narration: On November 25th, 2020, Maradona suffered cardiac arrest in his sleep at his home in Tigre.

#Video: Whiteboard-style doodle of a hospital room, "Diego Maradona" hand-lettered at the top. Olive-green wall, pale blue window panels at the right. Left: a cartoon figure of Diego Maradona lying on a white bed, seen from above the head — big scribbled mop of black curly hair, eyes closed, in a dark gown. On the wall above, a dark monitor showing a green ECG line. Center: a cartoon nurse leaning over him — white cap with a red cross, blue mask, blue scrubs, worried brow — holding a dark rectangular device against his chest. Right: two more masked nurses in caps and blue scrubs standing side by side, watching with anxious expressions.

#Narration: Emergency services were immediately called and medical personnel performed resuscitation attempts on site.

#Video: Whiteboard-style doodle of a hospital room, "Diego Maradona" hand-lettered at the top in marker font. Muted olive-green wall, white floor, curtain and IV pole at the left. Left: a cartoon figure of Diego Maradona lying on a white bed, a white sheet drawn up to his chest, scribbled black curly hair, gray beard, eyes closed. Right: a cartoon doctor standing beside the bed with his head bowed — green surgical cap, blue mask pulled down to his chin, white coat over blue scrubs, a clipboard lowered to his side. Above the bed, a small gray wall clock. Hand-lettered in the corner: "60 years old." The doctor lowering his head, the clock hand ticking once.
#Narration: Despite the intervention, he was pronounced dead shortly after their arrival. He was 60 years old.
#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: a faded gray silhouette of Diego Maradona with his scribbled mop of curly hair, drawn in outline only. Around him, three red-circled callout diagrams linked by red arrows: upper left, a tilted green bottle and a scatter of white pills; upper right, a dull red heart with black cracks running through it; lower center, a clipboard with scribbled illegible lines and a red cross at the top. Bottom third: a flat muted green band. The three callouts appearing one by one around the fading silhouette.
...
#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: a tall flagpole with the Argentine flag — light blue and white bands with the golden sun face — flying at half-mast, a black ribbon tied beneath it. Left: a simple pink government building with white columns and a small dome. Right: a doodled wall calendar with three days circled and crossed out in black marker. Bottom third: a flat gray band. The flag lowering slowly to half-mast, the three calendar days crossing out one by one.
#Narration: After Maradona's passing, Argentina declared 3 days of national mourning.
#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: a tall white obelisk monument with a pointed tip. Surrounding it, an enormous doodled crowd filling the entire lower two-thirds — hundreds of white outlined heads, raised arms, light blue and white striped shirts, small Argentine flags and hand-drawn banners held overhead, one reading "D10S." Gray blobs among them reading as cameras and phones. The crowd growing outward from the obelisk, flags waving.
#Narration: An estimated 1 million people gathered in Buenos Aires to pay tribute to the football legend.
#Video: Whiteboard-style doodle on a white background, "Diego Maradona" hand-lettered at the top in marker font. Center: three doodled phone screens arranged in a row, each with a black ribbon in the corner. Left screen: a blue club crest with a white "N" on it. Center screen: a cartoon portrait of Pelé in a cream-and-green collar. Right screen: a cartoon portrait of Cristiano Ronaldo in a dark shirt. Below the phones, a row of small doodled hearts and folded hands. Bottom third: a flat gray band. The three phone screens popping in one by one, hearts floating upward.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Diogo Jota.
#Narration: Diogo Jota.
#Video: Whiteboard-style doodle on a white background, "Diogo Jota" hand-lettered at the top in marker font. Center: a cartoon figure of Diogo Jota with short scribbled dark hair, a small smile, wearing a bright red shirt and red shorts, thin black stick legs, one foot resting on a doodled football. Left: a simple riverside skyline with a tall bridge arch and terracotta rooftops, hand-lettered "Porto, 1996." Right: a small green and red Portuguese flag. Bottom third: a flat bright green band. Jota tapping the ball, the flag waving.
...
#Video: Whiteboard-style doodle on a white background, "Diogo Jota" hand-lettered at the top in marker font. Center: a cartoon figure of Diogo Jota mid-stride in a red shirt, arms out, mouth open in a shout. Behind him, a doodled scoreboard with "100+ GAMES" scrawled across it in marker. Left: a red club crest with a small bird outline. Right: a green and red Portuguese crest. Bottom third: a flat bright green band with a white penalty-box line. The scoreboard number climbing, Jota celebrating.
#Narration: By 2022, he had played over a 100 games for Liverpool and his national team.
#Video: Whiteboard-style doodle on a white background, "Diogo Jota" hand-lettered at the top in marker font. Center: a sleek doodled green sports car in side profile, low and wedge-shaped, with two small cartoon figures visible inside — Diogo Jota with short dark hair at the wheel, his brother André Silva beside him. A long gray road stretches from left to right beneath them with dashed white center lines. Left edge: a small hand-lettered signpost reading "Spain." Right edge: a signpost reading "Santander." The car pulling away, road lines scrolling.
...
#Video: Whiteboard-style doodle on a dark navy background, "Diogo Jota" hand-lettered at the top in marker font. Center: the green sports car small in the distance on a long gray road curving toward the horizon, two yellow headlight cones cutting into the dark. Above, a scatter of small white stars and a thin crescent moon. Left: a doodled duffel bag and a pair of football boots tied by their laces, drawn as a small inset. The car driving into the distance, headlights flickering.
#Narration: It was meant to be a quiet journey before preseason training, but it ended in disaster.
#Video: Whiteboard-style doodle on a dark navy background, "Diogo Jota" hand-lettered at the top in marker font. Center: a two-lane gray highway seen from above, dashed white lines down the middle. The green sports car is drawn pulling out into the left lane alongside a boxy gray van, a curved white arrow showing the overtaking path. Upper left: a small doodled clock face reading 3:00 with "3:00 AM" hand-lettered beside it. Upper right: a green road sign reading "A52." Lower right: a small green Civil Guard badge doodle. The car swinging out to overtake the van.
...
#Video: Whiteboard-style doodle on a dark navy background, "Diogo Jota" hand-lettered at the top in marker font. Center: the green sports car drawn tilted and off-kilter, one front tire scribbled as a burst black shape with jagged fragments flying out and a red-circled callout pointing to it. Curved black motion arrows loop around the car showing it rolling. Right: orange and yellow scribbled flames rising. Bottom right: a small white roadside marker post hand-lettered "KM 64." The tire bursting, the car veering and rolling, flames rising.
...
#Video: Whiteboard-style doodle on a dark navy background, "Diogo Jota" hand-lettered at the top in marker font. Center: a twisted, blackened car shape barely recognizable, drawn as an angular scribble with orange and yellow flames wrapping around it and gray smoke curling upward. Left: a doodled red fire engine with a flashing blue light on top. Right: two cartoon firefighters in yellow helmets and reflective-striped coats, one holding a hose. The fire engine arriving, blue lights flashing, smoke curling.
#Narration: When emergency services arrived, the car was already engulfed in fire, its frame twisted beyond recognition.
#Video: Whiteboard-style doodle on a dark navy background, "Diogo Jota" hand-lettered at the top in marker font. Muted, subdued palette. Center: the blackened twisted car shape, flames now gone, thin gray smoke rising from it. Left: two cartoon firefighters in yellow helmets standing still with heads lowered, hose slack at their feet. Right: a white sheet doodled over a shape on the ground, drawn plainly and without detail. Above, two small white doodled birds. The last flames going out, smoke thinning, the firefighters lowering their heads.
...
#Video: Whiteboard-style doodle on a white background, "Diogo Jota" hand-lettered at the top in marker font. Center: a gray road surface seen from above with two long black scribbled skid marks curving off toward the shoulder, a doodled measuring tape stretched alongside them hand-lettered "30 m." Right: a cartoon investigator in a dark jacket crouching down, clipboard in hand, magnifying glass raised. Left: a small red-circled callout of a steering wheel with hands gripping it tightly. The skid marks drawing themselves across the road, the measuring tape extending.
...
#Video: Whiteboard-style doodle on a white background, "Diogo Jota" hand-lettered at the top in marker font. Center: a doodled stadium wall with a mural of Diogo Jota in a red shirt, scarves and bunches of flowers piled at its base. Left: a crowd of doodled fans in red, heads bowed, some holding red scarves stretched overhead. Right: a cartoon figure of Cristiano Ronaldo in a dark shirt, head lowered, one hand over his heart, a black armband on his sleeve. Bottom third: a flat gray band. Scarves and flowers piling up at the mural, fans bowing their heads.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Pelé.
#Narration: Pelé.
#Video: Whiteboard-style doodle on a white background, "Pelé" hand-lettered at the top in marker font. Center: a cartoon figure of Pelé with short scribbled black hair, a wide grin, wearing a cream shirt with a green collar and number 10, blue shorts, thin black stick legs. One arm is raised high with a clenched fist, one knee lifted mid-jump. Bottom third: a bright green band packed with a doodled crowd of fans — white outlined heads, raised arms, small yellow and green flags. Hand-lettered beside him: "1940." Pelé leaping with his fist raised, crowd cheering.
#Narration: Edson Arantes do Nascimento, known as Pelé, 1940, was regarded as the greatest footballer of all time.
#Video: Whiteboard-style doodle on a white background, "Pelé" hand-lettered at the top in marker font. Center: a cartoon figure of Pelé in a cream shirt with green collar, both arms outstretched. Above him, three shaded gold trophies floating in a row, each with a small hand-lettered year beneath: "1958," "1962," "1970." Right: a large doodled football with "1,200+ GOALS" scrawled across it in marker. Bottom third: a flat bright green band. The three trophies popping in one by one, the goal counter climbing.
#Narration: He won three FIFA World Cups, 1958, 1962, 1970, and scored over 1,200 career goals.
#Video: Whiteboard-style doodle on a white background, "Pelé" hand-lettered at the top in marker font. Center: a cartoon figure of Pelé mid-bicycle-kick, upside down in the air, cream shirt and blue shorts, one leg swung high at a doodled football. Curved white motion arcs trace the path of the kick. Around him, three small red-circled callouts hand-lettered "Technique," "Vision," "Finishing," each linked by a red arrow. Bottom third: a flat bright green band. The bicycle kick playing out, the three callouts appearing.
#Narration: His exceptional technique, vision, and scoring ability made him a defining figure in football history.
#Video: Whiteboard-style doodle of a clinic room, "Pelé" hand-lettered at the top in marker font. Muted olive-green wall, white floor. Left: a cartoon figure of an older Pelé sitting on an examination bed — short gray scribbled hair, gray mustache, tired eyes, a pale hospital gown, thin stick limbs. Center: a large pink cross-section diagram of a colon overlayed on the image, with a dark red mass marked on it hand-lettered "Tumor." Right: a cartoon doctor in a white coat over blue scrubs, stethoscope around the neck, one arm raised toward the diagram, a clipboard in the other hand. The doctor appearing, then the colon diagram appearing with the red mass.
#Narration: In 2021, Pelé was diagnosed with colon cancer.
#Video: Whiteboard-style doodle of a hospital room, "Pelé" hand-lettered at the top in marker font. Olive-green wall, white floor, IV pole at the left with a clear drip bag. Center: a cartoon figure of Pelé seated in a blue reclining chair, gray hair thinning, a blanket over his lap, a tube running from the drip bag to his arm. Above, a red-circled callout of a surgical tray with a scalpel and forceps, linked by a red arrow. Right: a doodled row of four chemotherapy bags hanging in a line, each with a small check mark beside it. The drip bag emptying, the check marks appearing one by one.
#Narration: He underwent surgery to remove the tumor, followed by multiple rounds of chemotherapy.
#Video: Whiteboard-style doodle on a white background, "Pelé" hand-lettered at the top in marker font. Center: a large pink outline diagram of a human torso, drawn front-on, with three dark red spreading blotches marked on it — one at the intestines, one at the lungs, one at the liver — each ringed in red and linked by a red arrow to a small hand-lettered label. Left: a doodled scan viewer panel with a pale film clipped to it. Right: a cartoon doctor in a white coat, brow furrowed, pointing at the diagram. Hand-lettered in the corner: "Early 2022." The three red blotches appearing and spreading one by one.
#Narration: Despite initial treatment, early 2022, scans revealed it metastasized in his intestines, lungs, and liver.
#Video: Whiteboard-style doodle of a hospital exterior and room, "Pelé" hand-lettered at the top in marker font. Left: a tall white hospital building with rows of blue windows and a red cross above the door, hand-lettered "São Paulo." Right: a cartoon figure of Pelé lying propped up in a white bed — gray hair, gray mustache, tired eyes, a clear oxygen tube at his nose, gray gown. Above him, a red-circled callout of a pair of pink lungs with small blue virus dots around them. A cartoon nurse in a blue mask and blue scrubs stands at the bedside with a clipboard. The hospital building appearing, then the lungs callout with the virus dots.
...
#Video: Whiteboard-style doodle of a hospital room, "Pelé" hand-lettered at the top in marker font. Muted palette. Center: a cartoon figure of Pelé lying in a white bed, gray hair, eyes half-closed, gray gown, a blanket drawn to his chest. Left: a doodled chemotherapy bag hanging from an IV pole with a large black X drawn across it. Right: a cartoon doctor in a white coat and a nurse in blue scrubs standing together, heads slightly bowed, one holding a clipboard hand-lettered "Palliative care." Hand-lettered in the corner: "December 3rd, 2022." The black X drawing itself across the chemo bag, the clipboard appearing.
...
#Video: Whiteboard-style doodle of a hospital room, "Pelé" hand-lettered at the top in marker font. Muted palette. Center: a cartoon figure of Pelé lying in a white bed, gray hair, eyes closed, shadows beneath them, oxygen tube at his nose. Two red-circled callout diagrams linked to him by red arrows: upper left, a pair of red kidneys drawn drooping and dull; upper right, a red heart looking distressed and misshapen. Above, a dark monitor screen showing an irregular green ECG line. Hand-lettered in the corner: "December 21st." The kidneys callout appearing, then the heart, the ECG line wavering.
...
#Video: Whiteboard-style doodle of a hospital room, "Pelé" hand-lettered at the top in marker font. Muted palette. Left: a cartoon figure of Pelé lying in a white bed with a dark monitor above him showing a green ECG line, a nurse in blue scrubs and mask standing watch beside him. Right: a doodled window looking out onto a small house with a decorated Christmas tree glowing inside it, drawn faintly in gray and green. A black X is drawn across the window pane. The Christmas tree appearing in the window, then the X drawing across it.
#Narration: Medical staff determined that he required intensive monitoring and was not allowed to spend Christmas at home.
#Video: Whiteboard-style doodle of a hospital room, "Pelé" hand-lettered at the top in marker font. Muted, subdued palette. Left: a cartoon figure of Pelé lying in a white bed, gray hair, eyes closed, a gray blanket pulled up over him against a white pillow, his expression peaceful. Right: a dark monitor screen showing a flat green line. Below it, a small doodled clock face with its hands reading 3:27, hand-lettered "3:27 p.m." In the corner, hand-lettered: "1940 – 2022. 82 years old." The ECG line getting progressively flatter, then going flat, the clock hands settling.
#Narration: On December 29th, 2022 at 3:27 p.m., Pelé passed away at the age of 82.
#Video: Whiteboard-style doodle on a white background, "Pelé" hand-lettered at the top in marker font. Center: a faded gray outline silhouette of Pelé in his number 10 shirt. Around him, three red-circled callout diagrams linked by red arrows: upper left, a pair of dull red kidneys with a black X; upper right, a dull red heart with a black X; lower center, a pair of pink lungs shaded dark and heavy. Below, a red-circled diagram of a colon with a dark red mass, hand-lettered "Adenocarcinoma." Bottom third: a flat gray band. The callouts appearing one by one around the fading silhouette.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of José Antonio Reyes.
#Narration: José Antonio Reyes.
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: a cartoon figure of José Antonio Reyes with short scribbled dark hair, a small confident smile, wearing a red shirt and white shorts, thin black stick legs, a doodled football at his feet. Right: a small red and yellow Spanish flag. Hand-lettered beside him: "1983." Bottom third: a flat bright green band with a white touchline. Reyes flicking the ball up, the flag waving.
#Narration: José Antonio Reyes, born 1983, was a prominent Spanish footballer of the early 2000s.
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: a cartoon figure of Reyes in a red shirt, both arms raised. Above him, three shaded silver and gold trophies floating in a row, hand-lettered beneath: "Champions League," "La Liga," "Europa League." Below, three doodled club crests in a row — a red and white striped crest, a red crest with a cannon, and a white crest with a crown. Bottom third: a flat bright green band. Trophies popping in one by one, then the three crests.
...
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: a doodled dark sedan in side profile on a gray road with dashed white center lines, three small cartoon figures visible inside — Reyes at the wheel with short dark hair, and two relatives beside and behind him. Left edge: a hand-lettered signpost reading "Utrera." Right edge: a signpost reading "Sevilla." Above, a pale sun and a few scribbled clouds. Bottom: dry scrubby doodled bushes along the roadside. The car driving from left to right, road lines scrolling.
...
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: the doodled dark sedan drawn with long white speed lines streaking behind it. Two red-circled callouts linked by red arrows: upper left, a speedometer with its red needle buried at the far end, hand-lettered "81 mph"; lower right, a steering wheel with a jagged red crack through the column and a tire below it drawn wobbling with warning marks. The speedometer needle climbing, then the red cracks appearing on the steering column and tire.
#Narration: The vehicle reported reaching speeds of 81 mph and had a steering and tire malfunction before the accident.
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: a gray road seen from a low angle, the doodled dark sedan swerving off the lane, a curved black motion arrow tracing its path toward the shoulder. Right: a gray metal roadside barrier with the car striking it, the front end crumpled inward in jagged scribbles, small black fragments flying outward. Sharp white impact lines radiate from the point of contact. The car swerving off the lane and striking the barrier, impact lines flashing.
...
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: the crumpled dark sedan against the bent gray barrier, now wrapped in orange and yellow scribbled flames climbing over the roof and bonnet, thick gray smoke curling upward and filling the top of the frame. Small orange sparks scatter around the base. Bottom: a scorched black patch spreading across the roadside gravel. Flames erupting from the car and spreading rapidly, smoke rising.
...
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Muted palette. Center: the blackened wreck against the barrier, flames out, thin gray smoke rising. Left: a doodled red fire engine and a white ambulance with blue flashing lights, two cartoon paramedics in green uniforms standing with heads lowered. Right: a cartoon figure on a stretcher with a red blanket over him, one arm bandaged, a paramedic wheeling him toward the ambulance. Blue lights flashing, the stretcher being wheeled toward the ambulance.
...
#Video: Whiteboard-style doodle on a white background, "José Antonio Reyes" hand-lettered at the top in marker font. Center: a faded gray outline silhouette of José Antonio Reyes in his red shirt. Two red-circled callout diagrams linked by red arrows: upper left, a side-view head diagram with a dark red impact mark at the skull, hand-lettered "Head trauma"; lower right, an outline torso shaded with orange and black scorch marks, hand-lettered "Burns." Right: a cartoon investigator in a dark jacket holding a clipboard, head lowered. Bottom third: a flat gray band. The two callouts appearing one after the other beside the fading silhouette.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Emiliano Sala.
#Narration: Emiliano Sala.
#Video: Whiteboard-style doodle on a white background, "Emiliano Sala" hand-lettered at the top in marker font. Center: a cartoon figure of Emiliano Sala with short scribbled dark hair, a broad smile, wearing a yellow shirt and green shorts, thin black stick legs, one arm raised. Behind him, a doodled staircase of three rising steps drawn with a white arrow climbing upward. Left: a small light blue and white Argentine flag. Right: a small blue, white and red French flag. Bottom third: a flat bright green band. Sala climbing the rising steps, the two flags popping in.
...
#Video: Whiteboard-style doodle on a white background, "Emiliano Sala" hand-lettered at the top in marker font. Center: a large red-circled diagram of a fingerprint with its looping ridges drawn in black marker, a doodled magnifying glass held over it. On either side, two small identical fingerprint cards linked to the center by red arrows, a green check mark between them. Right: a cartoon police officer in a dark uniform holding a clipboard. Left: a small badge doodle hand-lettered "Dorset Police." The magnifying glass sliding over the fingerprint, the two cards matching, the green check mark appearing.
#Narration: The Dorset police later confirmed through fingerprint analysis that the body was Emiliano Sala.
#Video: Whiteboard-style doodle on a white background, "Emiliano Sala" hand-lettered at the top in marker font. Muted palette. Center: a faded gray outline silhouette of Emiliano Sala in his yellow shirt. Two red-circled callout diagrams linked by red arrows: upper left, a side-view head diagram with dark red impact marks, hand-lettered "Head trauma"; lower right, an outline torso with dark red impact marks across the chest, hand-lettered "Torso trauma." Left: a doodled report page with a red stamp on it and "February 11th" hand-lettered beneath. Bottom third: a flat gray band. The report page appearing, then the two callouts one after the other.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Gary Speed.
#Narration: Gary Speed.
#Video: Whiteboard-style doodle on a white background, "Gary Speed" hand-lettered at the top in marker font. Center: a cartoon figure of Gary Speed with short scribbled dark hair, a calm smile, wearing a white shirt with a captain's armband on his sleeve, dark shorts, thin black stick legs. Above him, a hand-lettered banner reading "500+ Premier League matches." Around him, four small doodled club crests in a row — a white crest, a blue crest, a black-and-white striped crest, and a red Welsh dragon. Hand-lettered beside him: "1969." Bottom third: a flat bright green band. The crests popping in one by one, Speed smiling.
...
#Video: Whiteboard-style doodle on a white background, "Gary Speed" hand-lettered at the top in marker font. Center: a cartoon figure of Gary Speed standing on the touchline in a dark suit and tie, short scribbled hair, arms folded, a small serious smile. Beside him, a doodled tactics whiteboard on a stand with scribbled arrows and circles. Behind him, a row of empty dugout seats. Left: a red Welsh dragon flag on a small pole. Bottom third: a flat bright green band with a white touchline. The tactics board arrows drawing themselves, the flag waving.
#Narration: After retiring from professional football, he became the head coach of the Wales national team.
#Video: Whiteboard-style doodle on a white background, "Gary Speed" hand-lettered at the top in marker font. Left: a cartoon figure of Gary Speed in a dark suit sitting on a studio sofa under a doodled TV camera on a tripod, a small studio light above, hand-lettered "BBC One" on a panel behind him. Right: a doodled dark car driving along a road toward a small house with a pitched roof and a closed garage door, hand-lettered "Huntington, Cheshire." Above, a low orange evening sun and a small clock face reading 5:00. The camera light blinking on, then the car driving toward the house as the sun sets.
...
#Video: Whiteboard-style doodle on a white background, "Gary Speed" hand-lettered at the top in marker font. Muted, subdued palette. Center: the exterior of the house at dawn, gray sky, a closed gray garage door drawn large in the middle of the frame, its handle just turning. In front of it, a cartoon figure of Louise seen from behind — long scribbled hair, a dressing gown, one hand on the door, her shoulders drawn tense. Upper right: a small clock face reading just before 7:00. No interior is visible. The garage door beginning to lift, the frame holding on Louise from behind.
...
#Video: Whiteboard-style doodle on a white background, "Gary Speed" hand-lettered at the top in marker font. Muted palette. Left: two cartoon paramedics in green uniforms standing with their heads lowered and hands at their sides, a folded gray sheet beside them. Right: a doodled courtroom bench with a cartoon coroner in a dark robe seated behind it, a gavel and a stack of papers in front of them, hand-lettered "Inquest — January 30th, 2012." Between them, two red-circled callouts linked by red arrows: a scribbled tangle of dark lines hand-lettered "Pressure," and two small figures turned away from each other. The paramedics lowering their heads, then the courtroom bench appearing, then the two callouts.
...
#Video: grid of framed footballer portraits on an off-white background, thick black borders with soft drop shadows, names below each in a hand-drawn marker font. Diego Maradona in Argentina stripes, Diogo Jota in a red shirt, Pelé in Brazil's cream-and-green collar, José Antonio Reyes in red, Emiliano Sala in Nantes yellow, Gary Speed in a dark suit and tie, Suleiman al-Obeid in blue with number 10, Peter Biaksangzuala in blue-and-yellow. Zoom into portrait of Suleiman al-Obeid.
#Narration: Suleiman al-Obeid.
#Video: Whiteboard-style doodle on a white background, "Suleiman al-Obeid" hand-lettered at the top in marker font. Center: a cartoon figure of Suleiman al-Obeid with short scribbled dark hair and a trimmed beard, a warm smile, wearing a blue shirt with a white number 10, white shorts, thin black stick legs, a doodled football at his feet. Right: a doodled scoreboard scrawled with "100+ GOALS." Left: a small black, white, green and red Palestinian flag. Hand-lettered beside him: "1984." Bottom third: a flat bright green band. The goal counter climbing, the flag waving.
...
#Video: Whiteboard-style doodle on a white background, "Suleiman al-Obeid" hand-lettered at the top in marker font. Center: a cartoon figure of al-Obeid in his blue number 10 shirt, arms out, surrounded by a small doodled crowd of children and fans with raised arms and beaming faces, several holding small Palestinian flags. Above him, a hand-lettered banner reading "The Palestinian Pelé" with a red circle around it. Bottom third: a flat bright green band. The crowd of fans gathering around him, the banner unfurling.
#Narration: To Palestinian fans, he wasn't just a footballer. He was the Palestinian Pelé.
#Video: Whiteboard-style doodle on a white background, "Suleiman al-Obeid" hand-lettered at the top in marker font. Muted, dusty gray palette. Center: a doodled row of damaged buildings drawn as broken outlines with missing walls and jagged roof edges, gray rubble piled at their bases. Left: a doodled water pipe with a black X drawn across it and a snapped power line hanging loose. Right: an empty market stall with bare shelves, a red X over a crate. Above, a pale gray sky with drifting dust marks. Dust drifting across the frame, the red X marks appearing one by one.
#Narration: Due to the ongoing war which had devastated infrastructure and cut off regular supplies.
#Video: Whiteboard-style doodle on a white background, "Suleiman al-Obeid" hand-lettered at the top in marker font. Muted, dusty palette. Center: a long winding line of doodled civilians drawn as simple outlined figures with empty containers and bags, stretching from the foreground back toward the horizon. Near the front of the line, a cartoon figure of al-Obeid with a trimmed beard, standing patiently. Right: a doodled aid pallet stacked with white sacks under a tarp, a red cross on a small crate. Hand-lettered in the corner: "August 6th, 2025 — southern Gaza." The line of people extending back toward the horizon, dust drifting.
...
#Video: Whiteboard-style doodle on a white background, "Suleiman al-Obeid" hand-lettered at the top in marker font. Muted, dusty palette. Center: the aid distribution point drawn from a distance — the pallet and tarp on one side, the line of outlined civilians scattering outward. Sharp white burst lines and a hand-lettered "CRACK" in jagged marker font cut across the upper frame. Figures are drawn mid-motion: some dropping flat to the ground with arms over their heads, others running left and right, small dust puffs at their feet. No weapons or shooters are shown. The burst lines flashing across the frame, the crowd scattering and dropping.
...
#Video: Whiteboard-style doodle on a white background, "Peter Biaksangzuala" hand-lettered at the top in marker font. Muted palette. Center: a cartoon figure of Peter drawn in three faint overlapping stages — launching into the somersault, then rotating short with the arc drawn breaking off in red, then landing head-first on the green turf with sharp white impact lines at the point of contact. A red-circled callout points to his neck with a small jagged mark. Right: the last stage shows him lying motionless on the grass, eyes closed. The somersault rotating short, the arc breaking, the impact lines flashing, Peter lying still.
...
#Video: Whiteboard-style doodle of a hospital room, "Peter Biaksangzuala" hand-lettered at the top in marker font. Muted palette. Center: a cartoon figure of Peter lying in a white bed, eyes closed. Two red-circled callouts linked by red arrows: left, a doodled hand and foot with a black X over each and a small reflex hammer beside them, hand-lettered "No motor function"; right, a spine and nerve diagram with a black X. Above, a dark monitor showing a shallow, weakening green line. A doodled doctor and nurse stand at the foot of the bed with heads lowered. The two callouts appearing one after the other, the monitor line weakening.
#Narration: Medical staff reported no recovery of motor function or reflexes.
#Video: Whiteboard-style doodle of a hospital room, "Peter Biaksangzuala" hand-lettered at the top in marker font. Muted, subdued palette. Left: a cartoon figure of Peter lying in a white bed, eyes closed, a gray blanket pulled up over him against a white pillow, his expression peaceful. Right: a dark monitor screen showing a flat green line. Below it, a small doodled blue and yellow shirt folded neatly on a chair with a football beside it. Hand-lettered in the corner: "October 19th, 2014. 23 years old." The ECG line getting progressively flatter, then going flat, holding on the folded shirt.
...
#Narration: If you like this video, don't forget to subscribe and tell me which story you want next. Thanks for watching and see you in the next one.`,
	},
	{
		...
		`,
		exampleText: dedent`#Video: A chunky cartoon phone held up by a chibi YouTuber in a hoodie. A giant soup ladle pokes out through the phone screen and dumps a lumpy gray-green stew into a pig trough on the floor — and the trough itself is shaped like a red play button. The YouTuber pinches their nose with their free hand. A fat button on the phone reads "CREATE" with a sparkle on it. Ladle scooping and dumping, trough filling, YouTuber's cheeks puffing out.
...
#Video: A wobbling gray-green blob with a sparkle on it stands on a small stage, being pelted from both sides with tomatoes. Left crowd: chibi viewers holding popcorn. Right crowd: chibi creators holding cameras and microphones. Both crowds are throwing. A scoreboard above the stage reads "LIKES 3" and "DISLIKES 9,000,000". Tomatoes flying in from both sides, blob flinching, dislike counter spinning upward.

#Narration: This is despite the fact that AI generated media is almost universally despised by viewers and creators alike.

#Video: A laptop with an old-fashioned hand-crank meat grinder bolted to the top of the screen. The chibi host — round head, small glasses, gray t-shirt — is dropping two of his own cartoon characters into the hopper, one in a yellow shirt and one in purple, both waving their little arms in alarm. A sticky note on the laptop reads "make them argue about AI". Characters dropping into the hopper, crank turning, ominous grinding.
...
#Video: The two characters come out the other side badly wrong. The yellow one has seven fingers on a raised hand and a mouth that has slid onto its cheek; the purple one's face is melting off its head like warm ice cream while it gestures confidently. Their shirts have swapped colors halfway down. Subtitles across the bottom read "AI IS DANGERUOS" in wobbly misspelled letters. Faces melting and re-forming, extra fingers sprouting, subtitles glitching mid-word.
...
#Video: The host slumped low in a desk chair, mouth a flat line, giving a single slow thumbs-down at the laptop. On the desk beside him, an hourglass labeled "JOB SECURITY" with only a few grains left in the top bulb, and a torn-off calendar page. Sand trickling through the hourglass, host blinking once, very slowly.

#Narration: That was absolutely terrible, and my job is safe for another few months.

#Video: A browser window crammed edge to edge with fat colorful buttons, every single one stamped with a sparkle. The actual video player has been squeezed down to a postage-stamp rectangle in the bottom corner. A tiny chibi user leans in and squints at it through a magnifying glass. Buttons are spilling out of the window frame and piling up on the floor. New sparkle buttons popping in and shoving the video smaller, buttons overflowing onto the floor.

#Narration: Still, YouTube is overflowing with AI features that nobody asked for.

#Video: A tall vending machine labeled "INSPIRATION". A chibi creator feeds their old videos into a coin slot on the side; out of the dispensing tray at the bottom tumble identical thumbnails — the same crude shocked open-mouthed face with a red arrow and a red circle, over and over. The tray is already overflowing and the creator is knee-deep in duplicates. Videos going in, identical thumbnails tumbling out and piling up around the creator's legs.
...
#Video: A factory conveyor belt with three stations: a sparkle-covered machine, then a chibi creator sitting at a keyboard typing prompts, then an "UPLOAD" chute. A giant hand reaches down from the top of the frame and plucks the creator out like a Jenga block, dropping them into a bin marked "MIDDLEMEN". The two machines slide together to close the gap and the belt keeps running without missing a beat. Hand plucking the creator out, machines sliding together, belt speeding up.
...
#Video: A red play-button box wearing an apron, cutting a big round cake with a knife. It hands the larger slice, marked "55%", across the frame to a chibi creator, who is immediately spending it — the slice becomes a tripod, a light and a microphone in a small arrow-loop that circles back to a fresh cake. The play button keeps the smaller slice on its own plate. Knife slicing, the 55% slice sliding over, the loop of gear-to-cake spinning around.
...
#Video: The same cake, but the creator's chair is empty with a dotted outline where they used to be. The play-button box is eating the entire cake in one enormous bite, cheeks bulging. Behind it, a long low server building with a chimney; a small fork of cake is being shoveled into a furnace door labeled "GPUs", and an electricity meter on the wall is spinning so fast it's a blur. Play button swallowing the whole cake, meter dial spinning into a blur, furnace flaring.
...
#Video: A chibi viewer sits at a dinner table wearing a bib, cutlery in both fists, delighted. A waiter — the red play-button box in a little bow tie — serves a sequence of plates that get worse from left to right: a proper burger, then a burger with a sparkle stuck in it, then a plain bowl of gray-green mush. The viewer's happy expression never changes. Plates being swapped in one after another, each worse, the viewer beaming identically at every one.
...
#Video: A chibi executive in a boxy navy suit at a whiteboard, pointing with a marker at an equation drawn in three parts: a small doodle of a human creator, a minus sign, then a fat green arrow going up and a bag of money. Four more suits sit at the table nodding in perfect unison, eyes closed. The equation being written stroke by stroke, all four heads nodding in sync.

#Narration: On the surface, this seems to make rational business sense.

#Video: A gray dystopian street under a flat overcast sky. Enormous screens on every building play the same gray-green blob. Rows of identical chibi figures in matching jumpsuits stare upward with blank flat-line mouths. In the center of the square stands a monument shaped like a red play button — and a thick black crack is running up its plinth. One small figure sits on the curb with a sketchpad, drawing, ignored. Screens flickering in unison, the crack creeping up the plinth, the sketching figure looking up.
...
#Video: Three chibi viewers on a couch, bowls in hand, licking them completely clean. One has a gray-green mustache of slop across their face and is holding the bowl out for seconds with enormous pleading eyes. Beside the couch, a crossed-out drawing of a viewer looking nauseated, with a big red X over it. The host stands in the corner of the frame with a hand over his face. Bowls being licked clean, one held out for seconds, host's shoulders sagging.
...
#Video: The red play-button box lounges on a wooden throne in a lopsided gold crown, one leg over the armrest. At the foot of the throne, three small rival boxes attempt a coup and fail: one with a music note has a bent sword, one with a black X is charging at the wrong wall, and one with a blue f has its head stuck in a bucket. Rivals charging in and comically failing, the king not even looking up.
...
#Video: A playground roundabout. Chibi creators with cameras stand around the outside pushing it; chibi viewers with phones sit on it riding. A thick arrow loops from the pushers to the riders and back again. Sitting dead center on the roundabout's hub, the red play-button box has its eyes closed and its arms folded, doing absolutely nothing. The roundabout spinning faster and faster, the play button dozing at the hub.
...
#Video: A brand-new empty theater with a fresh "OPENING NIGHT" banner. A single hopeful chibi creator performs on stage to rows of completely empty seats, with a tumbleweed rolling through the aisle. Outside the glass doors, a crowd of viewers glances in, shrugs, and walks past toward a glow off-frame. Tumbleweed rolling, the performer's spotlight shrinking, the crowd outside walking past.
...
#Video: A warm banquet hall crammed with food. Inside, the play-button king sits at a groaning table surrounded by chibi creators and viewers all eating happily. Outside the window, three scrawny rival boxes press their faces to the glass holding empty bowls, ribs showing through their cardboard sides. A brass plaque over the door reads "COMPETITIVE ADVANTAGE". Steam rising off the feast, rival faces sliding slowly down the glass.
...
#Video: A phone screen showing a grid of nine thumbnails: eight are featureless gray-green blobs with sparkles, one is a small human face looking nervous. A "90%" is scrawled across the blobs in red marker. Off to the right, a chibi grifter in wraparound sunglasses shovels more blobs into the grid with a spade, whistling. The feed scrolling, the last human thumbnail getting shoveled over.
...
#Video: Two identical bowls of gray-green mush sitting side by side on a counter, each with a price card. The left card reads "+ 6 ADS". The right card reads "NO ADS, HAS FRIENDS" and has a little heart and a chat bubble drawn on it. A chibi viewer strolls toward the right bowl with their hands in their pockets, whistling, not agonizing about it in the slightest. Viewer glancing left, glancing right, walking right without breaking stride.
...
#Video: A freeze-frame with the host stepping into his own drawing, holding a big hand-lettered card reading "SCRATCH THAT" over the previous scene. Behind the card: the ladder has collapsed, the swirl box is yanking its own power cord out of the wall, and a small headstone reads "SORA". A receipt unspools from a cash register and trails right out of the frame. The card being slammed down, the plug popping out, the receipt unspooling endlessly.
...
#Video: A small graveside gathering. A row of chibi tech-company boxes in black ties stand around the "SORA" headstone, heads bowed, each writing in a tiny notepad. Every visible notepad page reads the same thing: "TRY AGAIN, BUT BIGGER". Heads bowing, pens scribbling in unison, one box already looking up hungrily.
...
#Video: The play-button king sits cheerfully on a thick tree branch, sawing through it on the trunk side of himself with a handsaw. With his other hand he leans down to hand a pamphlet reading "SLOP IS FINE!" to a chibi viewer standing below, who is reading it and nodding. Sawdust puffs; the branch has begun to bend. Saw working back and forth, sawdust puffing, the branch bowing.
...
#Video: A huge empty stadium, every seat vacant, confetti drifting down anyway. Alone at center field, the play-button king holds up a pie chart that is one solid green circle marked "100%", grinning at nobody. A single crow sits on the goalpost. A "100%" balloon tied to his wrist is quietly deflating. Confetti falling into empty seats, balloon shrinking, crow taking off.
...
#Video: A wide gray-green sea of mush, drawn with thick wobbly ridges instead of waves. A chibi creator sits in a little rowboat holding a camera in one hand and a fishing rod labeled "VIEWS" in the other; the hook dangles above the surface with nothing on it. Bobbing all around the boat to the horizon are thousands of identical blobs. Mush slowly heaving, boat rocking, empty hook swinging.
...
#Video: The same mush sea, wider. A corporate tower with a red play button on its roof is sunk in it up to the third floor and tilting. Four chibi executives stand on the roof in their boxy suits, briefcases in hand, still holding a meeting — one of them is pointing at a flipchart showing a green arrow going up. The tower settling deeper and tilting, the flipchart arrow still climbing.

#Narration: But in the long term, it's also potentially catastrophic for YouTube, the company.

#Video: A gilded picture frame containing an alternate universe. Inside it: the play-button king in a beret, respectfully handing a paintbrush to a chibi human artist on a pedestal, while a torch-and-pitchfork mob chases a gray-green blob out of town in the background. A banner over the scene reads "MADE BY HUMANS". Everything inside the frame is warm and sunlit. The framed scene glowing, mob chasing the blob off the edge of the frame.
...
#Video: A giant white blob figure with a large "G" on its front pushes a stroller down the street. Strapped into the stroller is the red play-button box, kicking its stick legs in protest. The G-parent holds a sparkle-covered rattle in its other hand and is shaking it enthusiastically at the child. Stroller rolling forward, play button kicking, rattle shaking.

#Narration: YouTube is owned by Google, and Google is one of the leading developers of generative AI.

#Video: A huge wall chart with a green line climbing steeply — and the climbing section is visibly held up from beneath by a single wooden prop with a sparkle painted on it, planted on a stack of server boxes. The prop is bowing under the weight and has one small crack in it. To the side, a chibi investor stares up at the line with dollar signs where its eyes should be, ignoring the prop entirely. The line climbing higher, the prop bowing and creaking, the crack widening slightly.
...
#Video: Two crowned figures handcuffed together at the wrist and facing opposite directions, straining to walk away from each other. One is a magnifying glass over a search bar; the other is the red play-button box. Between them, an enormous hand-lettered question mark. A tiny lawyer chibi at their feet shrugs with both palms up. Both figures straining outward, cuffs going taut, question mark growing.
...
#Video: The host stands sheepishly rubbing the back of his head next to an enormous corporate poster in cheery bubble lettering: "BRING BIG IDEAS TO LIFE" and "FUEL IMAGINATION", with a winged yellow lightbulb rising off the ground. One bottom corner of the poster has peeled away, revealing gray-green mush oozing out from behind it. The host has not noticed. The winged lightbulb flapping upward, the poster corner peeling further, mush oozing out.
...
#Video: Two bottles on a plain shelf under a hand-lettered "?" — on the left, a bloated milk carton with green stink lines rising off it and a fly hovering nearby wearing a tiny gas mask; on the right, a dark wine bottle with a neat label and a small gold medal hanging from its neck. Below the shelf, an empty comment box with a blinking cursor. Stink lines wafting, the fly adjusting its mask, cursor blinking.

#Narration: If you're watching this video in 5 years, comment below whether it aged like milk or wine.

#Video: A tiny island in the middle of the gray-green mush sea, just big enough for one chibi creator, their tripod and their camera. Sleeves rolled up, jaw set, they hammer a flag into the ground reading "HUMAN MADE". The mush is already lapping over their shoes. Mush rising up their ankles, flag going in with three firm hammer strikes, creator not budging.

#Narration: And if you're a YouTuber making real human content — good luck. You're going to need it.

#Video: The host waving with one hand. On his left, a chibi guest illustrator holds an oversized marker like a staff, with a small star doodle spinning beside their head and an arrow pointing at them. On his right, a row of chibi supporters wearing comically enormous hats — and the biggest hat has two blinking eyes and a small antenna, looking around the room by itself. The marker being raised, hats popping onto heads one by one, the big hat blinking and glancing around.
...
#Video: The host waving both arms overhead, eyes curved into happy arcs, standing on a plain flat ground line with a small scribbled sun behind him. His marker cap and a closed sketchbook sit on the ground beside his feet. Host waving, then a whiteboard eraser sweeping across from one side and wiping the whole drawing away.
