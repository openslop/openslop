...
export const TEMPLATES: Template[] = [
	...
	},
	{
		...
		exampleText: dedent`
			...
			#Video: Shot 1: Medium shot, slow push-in as Ethan stares down at a bathtub while dollar bills swirl down the drain. Sound: water gurgling down the drain. Shot 2: Close-up as Ethan's hand plunges into the water too late and the last bill slips away. Sound: a splash, then a final slurp from the drain.
			#Narration: Right now. Today. And you probably don't even know it's happening.

			#Video: Shot 1: Medium shot, static, Ethan holds up a sign that reads "$86/month." Shot 2: Quick push-in as the sign flips over to reveal "$219/month" and Ethan's eyes go wide. Sound: a sharp cardboard flip.
			...
			#Video: Shot 1: Medium shot with a hard camera shake as giant red on-screen text reading "$133 EXTRA / MONTH" slams onto the screen behind Ethan and his jaw drops all the way to the floor. Sound: a heavy impact thud, then a clunk as his jaw hits the floor.
			#Narration: That's 133 dollars more than people think. Every. Single. Month.

			#Video: Shot 1: Medium shot, static, a pie chart spins next to Ethan as he raises a finger to point at it. Sound: a soft whirring spin. Shot 2: Slow push-in on the chart as a red slice labeled "42%" pops out of it. Sound: a light pop.
			#Narration: And 42 percent of people are paying for stuff they already stopped using.

			#Video: Shot 1: Wide shot, slow push-in on Ethan sitting at a dark kitchen table, his face lit by his phone. Sound: a refrigerator humming, a wall clock ticking. Shot 2: Over-the-shoulder close-up of the phone screen showing "$43.17" with a red arrow pointing down, as a question mark floats up above Ethan's head. Sound: a soft screen tap.
			...
			#Video: Shot 1: Medium shot, Ethan slumps down onto a couch. Sound: couch cushions creaking. Shot 2: Slow tilt up as dollar bills float up around him one by one and vanish into the ceiling. Sound: faint paper rustling.
			...
			#Video: Shot 1: Wide shot, static, Ethan stands in workout clothes in an empty gym while a single treadmill runs on its own behind him. Sound: a treadmill motor humming in the background, the belt squeaking. Shot 2: Slow pan as a tumbleweed rolls past his feet across the gym floor. Sound: a dry tumbleweed scraping across rubber flooring.
			...
			#Video: Shot 1: Medium shot, Ethan holds up a shiny gym card. Shot 2: Punch-in as a price stamp reading "$69 / MONTH" slams onto the screen behind him. Sound: a heavy rubber stamp thunk.
			#Narration: The average gym costs 69 dollars a month.

			#Video: Shot 1: Medium shot, slow push-in as Ethan peeks through a Planet Fitness window at rows of empty treadmills. Sound: crickets chirping inside, faint hum of fluorescent lights. Shot 2: Close-up of Ethan's face as bold on-screen text floats above him reading "60% never visit in 30 days." Sound: a single cricket chirp.
			...
			#Video: Shot 1: Medium shot, Ethan stands at a chalkboard and writes "$69 × 12 = $828." Sound: chalk scratching and tapping on the board. Shot 2: Close-up as he circles the answer, then his shoulders drop in a sigh. Sound: chalk squeaking around the circle, a long exhale.
			#Narration: If you pay and don't go, that's 828 dollars a year. Gone.

			#Video: Shot 1: Medium shot, Ethan holds up an envelope stamped "CANCELLATION LETTER." Shot 2: The envelope sprouts little arms, leaps out of his hand and runs away across the floor as the camera pans after it. Sound: paper crinkling, tiny rapid footsteps fading away.
			...
			#Video: Shot 1: Medium shot, slow orbit around Ethan on the couch as he points a remote while Netflix, Hulu, Disney+, and Paramount+ logos circle around his head like planets. Sound: a remote button clicking, a low whoosh as each logo passes close by.
			...
			#Video: Shot 1: Medium shot, static, stats pop into the air next to Ethan as bold on-screen text, first "ESPN+: 26%" then "Hulu: 26%." Sound: a heavy thud as each one lands. Shot 2: Two more pop in beside them, "Paramount+: 25%" then "Disney+: 23%," as Ethan's eyes follow them. Sound: two more heavy thuds.
			...
			#Video: Shot 1: Medium shot, slow push-in as Ethan reaches his credit card toward a glowing mousetrap labeled "FREE 7-DAY TRIAL." Shot 2: Close-up as the trap snaps shut on his credit card and Ethan yelps and jerks his hand back. Sound: a sharp metal snap, then a yelp.
			#Narration: You sign up for a free trial. You type in your credit card. You forget. Seven days later — you're paying.

			#Video: Shot 1: Close-up on Ethan's phone as he opens his bank app and a red alert bubble pops up reading "65% of Americans got charged." Sound: a harsh notification buzz. Shot 2: Medium shot, Ethan clutches his chest and staggers back. Sound: a startled gasp.
			...
			#Video: Shot 1: Close-up as Ethan's thumb taps "Download" on his phone and a "DAY 1" stamp slams onto the screen. Sound: a screen tap, then a stamp thunk. Shot 2: Medium shot, a speech bubble graphic pops up next to Ethan with the text "89%" inside. Sound: a light pop.
			...
			#Video: Shot 1: Close-up on Ethan's phone as he signs up, then immediately taps "Cancel." Sound: two quick screen taps. Shot 2: Medium shot, Ethan grins slyly as an email pop-up appears beside him reading "Wait! 50% off to come back!" Sound: an email notification ding.
			...
			#Video: Shot 1: Medium shot, a dollar bill rips in two in front of Ethan. Sound: paper tearing. Shot 2: Ethan is left holding a tiny 17-cent scrap as the giant 83-cent piece flies off into a store window, the camera whipping to follow it. Sound: a whoosh of paper, then a soft slap against glass.
			...
			#Video: Shot 1: Medium shot, Ethan flashes a thumbs up as bold green on-screen text booms in next to him reading "SKIP THE WARRANTY." Sound: a deep booming impact.
			...
			#Video: Shot 1: Wide shot, slow push-in as old subscription logos crawl out of the ground of a graveyard, zombie style, and Ethan backs away. Sound: dirt crumbling, logos groaning and scraping. Shot 2: Close-up as the logos claw their way onto Ethan's credit card. Sound: claws scratching on plastic.
			#Narration: These are the worst. The subscription is dead to you. But it's still alive on your credit card.

			#Video: Shot 1: Medium shot, static, Ethan stares at a card floating in front of him that reads "60% forgot a recurring payment" and scratches his head. Sound: fingernails scratching hair.
			...
			#Video: Shot 1: Medium shot, Ethan flips a calendar page and the month is stamped red with a giant X. Sound: a page flip and a stamp thunk. Shot 2: He flips two more months, each stamped red with a giant X, wincing with each flip. Sound: two more page flips and stamp thunks.
			...
			#Video: Shot 1: Wide shot, a factory machine labeled "BIG COMPANIES" runs in front of Ethan. Sound: machinery clanking and whirring. Shot 2: Close-up as a mechanical arm reaches into Ethan's pocket, pulls out dollar bills and drops them onto a conveyor belt. Sound: servo motors whining, a conveyor belt rattling.
			...
			#Video: Shot 1: Medium shot, Ethan grabs a big red lever and yanks it down. Sound: a heavy metal clunk. Shot 2: Wide shot as the conveyor belt reverses and money pours back into his piggy bank while Ethan grins. Sound: the belt grinding into reverse, coins clinking into the piggy bank.
			...
			#Video: Shot 1: Extreme close-up of Ethan's iPhone as his thumb taps "Settings," then his name. Sound: soft screen taps. Shot 2: His thumb taps "Subscriptions" and a long list scrolls into view as the camera holds on the screen. Sound: a tap, then a smooth scroll.
			...
			#Video: Shot 1: Close-up on Ethan's thumb tapping "Cancel" over and over as an on-screen counter ticks up "1, 2, 3, 4, 5…" Sound: rapid screen taps, a click with each tick. Shot 2: Medium shot, Ethan's smile grows bigger with each tap.
			...
			#Video: Shot 1: Medium shot, Ethan sits at his kitchen table holding a red marker over his bank statement. Shot 2: Close-up as he circles three repeating charges one by one and the numbers glow. Sound: a marker squeaking on paper.
			...
			#Video: Shot 1: Close-up as Ethan types "subscription, renewal, free trial" into his email search bar. Sound: keyboard keys clacking. Shot 2: Wide shot, old emails fly out of the screen and pile up around him. Sound: a flurry of paper flapping.
			...
			#Video: Shot 1: Close-up as Ethan taps his bank app and sets up an auto-transfer. Sound: screen taps. Shot 2: Medium shot, a glowing arrow labeled "$100 / month" flows out of his account and into a piggy bank. Sound: coins clinking into the piggy bank.
			...
			#Video: Shot 1: Wide shot, slow tilt up from older Ethan with grey hair standing under a giant money tree to a glowing "$632,000" hanging at the top. Sound: leaves rustling in a breeze. Shot 2: Medium shot as leaves of cash drift down around him. Sound: paper bills fluttering.
			...
			#Video: Shot 1: Medium shot, Ethan points at bold on-screen text that bounces in reading "Can't do 12%? Start with 1%." Sound: a springy bounce. Shot 2: Close-up as a tiny coin drops into a piggy bank beside him. Sound: a single coin clink.
			...
			#Video: Shot 1: Wide shot, slow push-in as Ethan's silhouette slowly straightens up tall and strong. Shot 2: The white on-screen text beside him rewrites itself to read "Or you can stop forgetting."
...
#Video: Shot 1: Wide shot, caption "Diogo Jota" at the top, a riverside skyline with a tall bridge arch and terracotta rooftops at the left labeled "Porto, 1996," and a small green and red Portuguese flag waving at the right, Diogo Jota standing small in front of the skyline. Sound: river water lapping, a flag flapping. Shot 2: Medium shot of Diogo Jota in the center with short dark hair and a small smile, in a bright red shirt and red shorts, thin stick legs, tapping a football with one foot on a flat bright green band. Sound: a ball being tapped.
...
#Video: Shot 1: Medium shot on a dark navy background, caption "Diogo Jota" at the top, one front tire of the green sports car bursts into a black shape with jagged fragments flying out, a red-circled callout pointing to it. Sound: a loud tire blowout bang, rubber flapping. Shot 2: Wide shot as the car veers off-kilter and rolls along curved black motion arrows, past a white roadside marker post reading "KM 64" at the bottom right, as orange and yellow flames rise. Sound: metal crunching as the car rolls, flames whooshing up.
...
#Video: Shot 1: Medium shot on a dark navy background, caption "Diogo Jota" at the top, a twisted, blackened car shape barely recognizable, wrapped in orange and yellow flames with gray smoke curling upward, two firefighters running in at the right edge. Sound: fire roaring and crackling close by. Shot 2: Wide shot as a red fire engine arrives at the left with its blue light flashing, and the two firefighters in yellow helmets and reflective-striped coats stand at the right, one holding a hose. Sound: a siren winding down, air brakes hissing.
#Narration: When emergency services arrived, the car was already engulfed in fire, its frame twisted beyond recognition.
#Video: Shot 1: Medium shot on a dark navy background, caption "Diogo Jota" at the top, the last flames on the blackened, twisted car go out and thin gray smoke rises from it, two small white birds above, two firefighters standing at the left edge. Sound: embers hissing, water dripping. Shot 2: Wider shot revealing the two firefighters in yellow helmets at the left lowering their heads, a slack hose at their feet, and a plain white sheet laid over a shape on the ground at the right, shown plainly without detail. Sound: a hose dribbling onto asphalt, quiet wind.
...
#Video: Shot 1: Medium shot of a hospital room, caption "Pelé" at the top and "December 3rd, 2022" written in the corner, Pelé lies in a white bed with gray hair, eyes half-closed, a gray gown and a blanket drawn to his chest, a chemotherapy bag hanging from an IV pole at the left, a doctor and a nurse standing at the right. Sound: a monitor beeping slowly. Shot 2: A black X draws itself across the chemo bag as, at the right, the doctor in a white coat and the nurse in blue scrubs stand together with heads slightly bowed and a clipboard labeled "Palliative care" appears in one of their hands. Sound: a marker squeaking.
...
#Video: Shot 1: Medium shot, caption "José Antonio Reyes" at the top and "1983" written beside him, José Antonio Reyes with short dark hair and a small confident smile, in a red shirt and white shorts with thin stick legs, flicks a football up from his feet on a bright green band with a white touchline. Sound: a ball flicked off a boot. Shot 2: Pan right to a small red and yellow Spanish flag waving. Sound: fabric flapping in the wind.
#Narration: José Antonio Reyes, born 1983, was a prominent Spanish footballer of the early 2000s.
#Video: Shot 1: Medium shot, caption "José Antonio Reyes" at the top, Reyes in a red shirt raises both arms on a flat bright green band as three silver and gold trophies pop in one by one above him, labeled "Champions League," "La Liga," and "Europa League." Sound: three metallic clinks. Shot 2: Tilt down as three club crests pop in below: a red and white striped crest, a red crest with a cannon, and a white crest with a crown. Sound: three soft pops.
...
#Video: Shot 1: Medium shot, caption "José Antonio Reyes" at the top, the dark sedan races with long white speed lines streaking behind it as a red-circled callout of a speedometer appears at the upper left, its red needle climbing to the far end, labeled "81 mph." Sound: an engine screaming at high revs. Shot 2: Push-in on a second callout at the lower right as a jagged red crack appears through the steering column and the tire below it wobbles with warning marks. Sound: metal creaking, a tire thumping unevenly.
#Narration: The vehicle reported reaching speeds of 81 mph and had a steering and tire malfunction before the accident.
#Video: Shot 1: Low-angle shot of a gray road, caption "José Antonio Reyes" at the top, the dark sedan swerves off its lane along a curved black motion arrow toward the shoulder. Sound: tires screeching. Shot 2: The car strikes a gray metal roadside barrier at the right, its front end crumpling inward, small black fragments flying outward as sharp white impact lines flash from the point of contact. Sound: a violent crunch of metal on metal, debris scattering.
...
#Video: Shot 1: Medium shot, caption "José Antonio Reyes" at the top, flames erupt from the crumpled dark sedan against the bent gray barrier and spread rapidly over the roof and bonnet, small orange sparks scattering around the base. Sound: a whoomph of ignition, fire roaring close by. Shot 2: Slow tilt up as thick gray smoke curls upward and fills the top of the frame while a scorched black patch spreads across the roadside gravel. Sound: flames crackling, glass popping in the heat.
...
#Video: Shot 1: Medium shot, caption "Emiliano Sala" at the top, Emiliano Sala with short dark hair and a broad smile, in a yellow shirt and green shorts with thin stick legs, one arm raised, climbs a staircase of three rising steps beside a white arrow climbing upward, on a flat bright green band. Sound: footsteps thudding up the steps. Shot 2: A small light blue and white Argentine flag pops in at the left and a small blue, white and red French flag at the right. Sound: flags flapping.
...
#Video: Shot 1: Overhead wide shot of open sea in pale blue, caption "Emiliano Sala" at the top, as a large search grid of dashed squares draws itself square by square across it, labeled "4,400 km²," a small green and white police badge at the left and a calendar with three days circled at the upper right. Sound: waves rolling below. Shot 2: A helicopter sweeps across the grid with a searchlight cone while small boats move beneath it. Sound: helicopter rotors thumping, boat engines droning.
...
#Video: Shot 1: Wide shot, caption "Emiliano Sala" at the top and "February 7th" written in the corner, a recovery vessel on gray water at the left extends a crane arm over the side, two crew members in orange jackets on its deck, its cable slowly lifting from the sea, a small harbor with a dock and a building labeled "Portland" at the right. Sound: a crane winch grinding, water lapping against the hull. Shot 2: Medium shot of a stretcher covered with a plain white sheet, shown simply and without detail, being lifted onto the deck as the two crew members on either side lower their heads. Sound: the stretcher settling on a metal deck, gulls in the distance.
...
#Video: Shot 1: Medium shot, caption "Emiliano Sala" at the top, a large red-circled fingerprint with looping black ridges sits center as a magnifying glass slides over it, a small badge labeled "Dorset Police" at the left and a police officer in a dark uniform holding a clipboard at the right. Sound: glass sliding over paper. Shot 2: Push-in as two small identical fingerprint cards on either side, linked to the center by red arrows, match up and a green check mark appears between them. Sound: a pen ticking paper.
...
#Video: Shot 1: Wide shot, caption "Gary Speed" at the top, Gary Speed stands on the touchline in a dark suit and tie, arms folded, a small serious smile, beside a tactics whiteboard on a stand, a row of empty dugout seats behind him and a red Welsh dragon flag waving on a small pole at the left, above a green band with a white touchline. Sound: a flag flapping in the wind. Shot 2: Close-up on the tactics board as arrows and circles draw themselves across it. Sound: a marker squeaking on a whiteboard.
#Narration: After retiring from professional football, he became the head coach of the Wales national team.
#Video: Shot 1: Medium shot, caption "Gary Speed" at the top, Gary Speed in a dark suit sits on a studio sofa under a TV camera on a tripod as the camera's light blinks on, a small studio light above and a panel behind him reading "BBC One." Sound: studio air conditioning humming. Shot 2: Wide shot as a dark car drives along a road toward a small house with a pitched roof and a closed garage door, labeled "Huntington, Cheshire," while a low orange evening sun sets beside a small clock face reading 5:00. Sound: a car engine on a quiet road, birdsong fading.
...
#Video: Shot 1: Medium side shot, caption "Gary Speed" at the top, Louise kneels on a gray driveway with her hair loose, a phone pressed to her ear, her free hand raised to her mouth, small blue teardrop marks at her cheeks and shaky motion lines around her trembling shoulders. Sound: ragged breathing. Shot 2: Push-in on a small red-circled emergency call icon pulsing beside the phone, the gray house behind her with the open garage shown as a plain dark rectangle with no detail inside. Sound: a phone line ringing.
#Narration: Shocked and trembling, she called emergency services immediately.
#Video: Shot 1: Medium shot, caption "Gary Speed" at the top, Louise kneels on a gray floor, a phone set down beside her on speaker with small sound arcs pulsing from it, both hands reaching desperately toward a plain gray sheet-covered shape on the ground beside her, shown without any detail, brow raised, teardrop marks at her cheeks. Sound: a phone speaker crackling. Shot 2: Close-up of a clock face at the right, its second hand sweeping. Sound: a clock ticking loudly.
...
#Video: Shot 1: Medium shot, caption "Peter Biaksangzuala" at the top and "October 14th, 2014" written in the corner, a football flies along white motion lines into the back of a white goal net above a bright green band with a white goal line, Peter watching from the left. Sound: a ball swishing into the net. Shot 2: Peter in a blue and yellow shirt throws both arms up, mouth open in a shout, as a scoreboard at the right flips level to "1 – 1." Sound: a crowd erupting, a scoreboard flipping over.
#Narration: On October 14th, 2014, during a league match against Chanmari West FC, he scored an equalizing goal.
#Video: Shot 1: Tracking shot, caption "Peter Biaksangzuala" at the top, Peter sprints right toward a corner flag with arms pumping and a big grin, motion lines behind him, on a bright green band with a white corner arc, a small red-circled inset at the upper right of a player mid-somersault labeled "Miroslav Klose." Sound: studs pounding on grass. Shot 2: A curved white dashed arc draws itself up and over from his feet showing the somersault he intends, beside the Klose inset. Sound: a crowd roaring in the distance.
...
#Video: Shot 1: Medium shot, caption "Peter Biaksangzuala" at the top, three faint overlapping stages of Peter: launching into the somersault, rotating short as the arc breaks off in red, then landing head-first on the green turf as sharp white impact lines flash at the point of contact. Sound: a heavy thud on turf, a crowd gasping. Shot 2: Push-in on Peter lying motionless on the grass, eyes closed, as a red-circled callout points to a small jagged mark at his neck. Sound: the stadium falling silent, wind across the pitch.
...
#Video: Shot 1: Medium shot, caption "Peter Biaksangzuala" at the top, Peter lies motionless on the green turf, eyes closed, arms at his sides, one teammate in a blue and yellow shirt kneeling beside him with a worried brow while two others stand and wave both arms urgently toward the touchline, where two medics in white wait with a stretcher. Sound: studs shuffling on grass. Shot 2: Pan right as the two medics run onto the pitch carrying the stretcher. Sound: running footsteps, a stretcher frame rattling.
...
#Video: Shot 1: Wide shot of an intensive care room with an olive-green wall, white floor and a curtain at the left, caption "Peter Biaksangzuala" at the top, Peter lies in a white bed, eyes closed, in a white neck brace, a ventilator tube taped at his mouth running to a boxy gray machine with small dials and a green display that cycles beside the bed, a nurse standing at the right. Sound: a ventilator hissing and clicking rhythmically. Shot 2: Medium shot of the nurse in a blue mask and blue scrubs at the right watching closely with a clipboard, as a dark monitor above traces a green ECG line and a second wavy blue line. Sound: steady monitor beeps.
...
#Video: Shot 1: Medium shot, static, the host slumps low in a desk chair, mouth a flat line, gives a single slow thumbs-down at the laptop and blinks once, very slowly. Sound: the desk chair creaking. Shot 2: Close-up on the desk beside him, sand trickling through an hourglass labeled "JOB SECURITY" with only a few grains left in the top bulb, next to a torn-off calendar page. Sound: faint sand trickling.

#Narration: That was absolutely terrible, and my job is safe for another few months.

#Video: Shot 1: Wide shot, a browser window crammed edge to edge with fat colorful buttons, each stamped with a sparkle, as new sparkle buttons pop in and shove the video player down to a postage-stamp rectangle in the bottom corner, a tiny user standing in front of it. Sound: rapid bubbly pops. Shot 2: Slow push-in on the tiny user leaning in to squint at the video through a magnifying glass while buttons spill out of the window frame and pile up on the floor. Sound: plastic buttons clattering onto the floor.

#Narration: Still, YouTube is overflowing with AI features that nobody asked for.

#Video: Shot 1: Medium shot, a creator feeds their old videos into the coin slot on the side of a tall vending machine labeled "INSPIRATION." Sound: a coin-slot whir and clunk. Shot 2: Slow tilt down to the dispensing tray as identical thumbnails of the same crude shocked open-mouthed face with a red arrow and a red circle tumble out over and over, piling up until the creator is knee-deep in duplicates. Sound: stiff cards clattering onto a growing pile.
...
#Video: Shot 1: Wide shot, slow pan along a factory conveyor belt with three stations: a sparkle-covered machine, a creator sitting at a keyboard typing prompts, and an "UPLOAD" chute. Sound: a conveyor belt rattling, keyboard keys clacking. Shot 2: A giant hand reaches down from the top of the frame, plucks the creator out like a Jenga block and drops them into a bin marked "MIDDLEMEN." Sound: a thump into the bin. Shot 3: The two machines slide together to close the gap and the belt speeds up without missing a beat. Sound: machines grinding together, the belt rattling faster.
...
#Video: Shot 1: Medium shot inside a warm banquet hall crammed with food, the play-button king sits at a groaning table surrounded by creators and viewers eating happily, steam rising off the feast, a brass plaque over the door reading "COMPETITIVE ADVANTAGE," three scrawny rival boxes peering in through the window at the back. Sound: cutlery clinking, cheerful chewing. Shot 2: Reverse shot from outside the window, the three scrawny rival boxes with ribs showing through their cardboard sides press their faces to the glass holding empty bowls, faces slowly sliding down. Sound: faces squeaking down the glass.
...
#Video: Shot 1: Medium shot, the host steps into his own drawing and slams a big hand-lettered card reading "SCRATCH THAT" down over the previous scene, the swirl box still poking out from behind the card. Sound: a card slapping down. Shot 2: Wide shot of the scene behind the card: the ladder has collapsed, the swirl box yanks its own power cord out of the wall with the plug popping out, a small headstone reads "SORA," and a receipt unspools endlessly from a cash register out of the frame. Sound: a plug popping out of a socket, a register printer chattering.
...
#Video: Shot 1: Wide shot, a huge empty stadium with every seat vacant and confetti drifting down anyway, the play-button king alone at center field holding up a solid green pie chart marked "100%," grinning at nobody, a crow perched on the goalpost. Sound: wind echoing through empty stands. Shot 2: Medium shot as a "100%" balloon tied to his wrist quietly deflates and the crow on the goalpost takes off. Sound: air hissing from the balloon, a crow's wings flapping away.
...
#Video: Shot 1: Wide shot, a vast gray-green sea of mush slowly heaving in thick wobbly ridges, thousands of identical blobs bobbing all the way to the horizon, a creator in a little rowboat rocking among them. Sound: thick mush sloshing. Shot 2: Medium shot, the creator in the little rocking rowboat holds a camera in one hand and a fishing rod labeled "VIEWS" in the other, the empty hook swinging above the surface. Sound: the boat creaking, a fishing line swishing.
...
#Video: Shot 1: Wide shot, the same mush sea, wider, as a corporate tower with a red play button on its roof settles deeper, sunk up to the third floor and tilting, four executives in boxy suits standing on its roof. Sound: steel groaning, mush gurgling. Shot 2: Medium shot on the roof, the four executives hold briefcases and carry on a meeting, one pointing at a flipchart whose green arrow keeps climbing. Sound: flipchart pages rustling in the wind.

#Narration: But in the long term, it's also potentially catastrophic for YouTube, the company.

#Video: Shot 1: Slow push-in on a gilded picture frame holding a warm, sunlit alternate universe: the play-button king in a beret respectfully hands a paintbrush to a human artist on a pedestal beneath a banner reading "MADE BY HUMANS," a torch-and-pitchfork mob and a gray-green blob at the edge of town behind them. Shot 2: Inside the frame, the torch-and-pitchfork mob chases the gray-green blob out of town and off the edge of the frame. Sound: a distant mob hollering, running footsteps, torches crackling.
...
#Video: Shot 1: Tracking shot, a giant white blob figure with a large "G" on its front pushes a stroller down the street, enthusiastically shaking a sparkle-covered rattle at the red play-button box strapped inside, which kicks its stick legs in protest. Sound: stroller wheels rolling on pavement, a rattle shaking.
