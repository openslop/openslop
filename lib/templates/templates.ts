...
#Video: Shot 1: Wide shot, caption "Gary Speed" at the top, a white ambulance arrives on the driveway at the left with blue lights flashing and back doors open, two paramedics in green uniforms climbing out, a small clock labeled "20 minutes" above. Then pan right as two red-circled callouts appear: a ticking stopwatch labeled "8 minutes," and a thermometer with a blue bulb labeled "Pale and cold." Sound: a siren cutting off, ambulance doors swinging open. Shot 2: Medium shot of the two paramedics kneeling on a gray floor over a plain gray sheet-covered shape shown without detail, one with hands positioned for compressions, the other holding a bag valve mask. Sound: rhythmic compressions, a bag valve mask squeezing.
...
#Video: Shot 1: Wide shot, slow pan along a factory conveyor belt with three stations: a sparkle-covered machine, a creator sitting at a keyboard typing prompts, and an "UPLOAD" chute. Then the two machines slide together to close the gap and the belt speeds up without missing a beat. Sound: a conveyor belt rattling, keyboard keys clacking. Shot 2: A giant hand reaches down from the top of the frame, plucks the creator out like a Jenga block and drops them into a bin marked "MIDDLEMEN." Sound: a thump into the bin.
...
#Video: Shot 1: Wide shot, slow push-in on a gray dystopian street under a flat overcast sky, enormous screens on every building flickering in unison with the same gray-green blob, rows of identical figures in matching jumpsuits staring upward with blank flat-line mouths, one small figure sitting apart on a curb. Then close-up of the small figure on the curb with a sketchpad, drawing, ignored, who looks up. Sound: an electric buzz from the screens echoing off buildings. Shot 2: Medium shot of a monument shaped like a red play button in the center of the square as a thick black crack creeps up its plinth. Sound: stone cracking.
...
#Video: Shot 1: Wide shot, slow tilt up a huge wall chart as a steep green line climbs higher, its climbing section held up from beneath by a single wooden prop with a sparkle painted on it, planted on a stack of server boxes, an investor standing off to the side. Then medium shot of the investor off to the side with dollar signs for eyes, staring up at the line and ignoring the prop entirely. Sound: servers humming. Shot 2: Close-up on the prop bowing under the weight as a small crack in it widens slightly. Sound: wood creaking.
