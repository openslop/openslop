...
- **Media tints:** `--media-character/image/video/music/sound/narration` color the element-card icon so each storyboard type reads at a glance. Brighter in dark, deeper in light.
