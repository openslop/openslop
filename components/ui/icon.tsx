...
export const CollapseTimeline = icon("collapse-timeline");
export const Contrast = icon("contrast");
export const Coin1 = icon("coin-1");
export const Coin2 = icon("coin-2");
export const Coin3 = icon("coin-3");
...
export const ExpandTimeline = icon("expand-timeline");
...
export const InsertElement = icon("insert-element");
export const InsertElementFill = icon("insert-element-fill");
...
export const LinkedOff = icon("linked-off");
export const LinkedOn = icon("linked-on");
...
export const Minutes1 = icon("minutes-1");
export const Minutes2 = icon("minutes-2");
export const Minutes3 = icon("minutes-3");
...
export const Pin = icon("pin-alt-full");
...
export const RobotFill = icon("robot-fill");
...
export const Transition = icon("transition");
export const Translate = icon("translate");
export const Trim = icon("trim");
